...
export const TESTIMONIALS_DATA: Testimonial[] = [
    {
        ...
        quote: "JALA Educators transformed my life. From a village girl with big dreams to a software developer at Safaricom. The mentorship program connected me with industry professionals who guided my career path.",
        rating: 5
    },
    {
        id: 2,
